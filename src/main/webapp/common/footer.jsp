	...
	<div class="container-fluid tm-container-small">
		<div class="row">
			<div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
				<h3 class="tm-text-primary mb-4 tm-footer-title">FT-1</h3>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 col-12 px-5 mb-5">
				<h3 class="tm-text-primary mb-4 tm-footer-title">FT-2</h3>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 col-12 px-5 mb-5">
		...
		<div class="row">
			<div class="col-12 px-5 mb-3">Copyright 2023
				Kïet. All rights reserved.
			</div>
		</div>
	</div>
</footer>
