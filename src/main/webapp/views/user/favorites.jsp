...
<body>
	...
	<div class="container-fluid tm-container-content tm-mt-60">
		<div class="row mb-4">
			<h2 class="col-6 tm-text-primary">Danh Sách Videos Yêu Thích</h2>
		...
		<div class="row tm-mb-90 tm-gallery">
			...
			<c:forEach items="${videos}" var="video">
				<div class="col-xl-34 col-lg-4 col-md-4 col-sm-4 col-12 mb-5">
					<h5 style="color: #FFD700;">${video.title}</h5>
					<figure class="effect-ming tm-video-item">
						<img src="${video.poster}" alt="Image" class="img-fluid">
						<figcaption
							class="d-flex align-items-center justify-content-center">
							<h2>Play</h2>
							<a href="<c:url value='/video?action=watch&id=${video.href}' />">Play</a>
						</figcaption>
					</figure>
